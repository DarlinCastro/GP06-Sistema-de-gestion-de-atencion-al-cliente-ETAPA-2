    ...
    <head>
        ...
        <style>
            * {
            ...
            /* Contenedor flex para logo y botones */
            .content-flex {
                display: flex;
                align-items: center;
                gap: 80px;
            ...
            <div class="menu-wrapper">
                <div class="content-flex">
                    ...
                    <div class="menu-buttons">
                        <h1 class="menu-title">Menu Tecnico y Programador</h1>
                        <a href="GenerarReporteController?origen=MenuTecnico.jsp" class="menu-btn">
                            Generar Reportes
                        </a>
                        <a href="Seguimiento?origen=MenuTecnico.jsp" class="menu-btn">
